      ...
      <div className="container mx-auto px-4 max-w-[1400px]">
        ...
        <div className="border-t border-[#223043] pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="/docs/Privacy_Policy.pdf" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">Privacy Policy</a>
            <a href="/docs/Terms_of_Service.pdf" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">Terms of Service</a>
            <a href="/docs/Cookie_Policy.pdf" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
