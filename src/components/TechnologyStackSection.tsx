      ...
      <div className="container mx-auto px-4 max-w-[1400px]">
        <div className="text-center mb-4 md:mb-12 lg:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white my-4">
            Powering Finance with Cutting-Edge Blockchain
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto">
            BlueLink harnesses advanced blockchain technology to deliver a
            secure, scalable, and innovative financial ecosystem, seamlessly
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8 bg-[#1F2937]/50 border border-[#374151] p-8 rounded-lg md:rounded-xl lg:rounded-2xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              {technologies.map((tech, idx) => (
                <div
                  key={idx}
                  className="p-4 flex flex-col items-center justiy-center"
                >
                  <div className="p-4 bg-[#374151]/50 rounded-lg w-fit h-fit">
                    <img src={tech.icon} className="w-9 h-9" />
                  </div>
                  <h4 className="text-[#D1D5DB] font-medium text-center">
                    {tech.name}
                  </h4>
                </div>
              ))}
          ...
          <div className="rounded-lg overflow-hidden shadow-xl ring-1 ring-teal-400/20 shadow-teal-500/20 border border-gray-500 perspective-1000">
            <img
              src={handshake}
              alt="Blockchain"
